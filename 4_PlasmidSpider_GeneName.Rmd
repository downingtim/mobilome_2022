...
rrr # r =0.914
pdf("Figure_2_revised.pdf", width=6, height=6)
ggplot(fullPMNLE, aes(x= log10(fullPMNLE$inputProteins), y=log10(fullPMNLE$interactions))) +
  ...
  scale_x_continuous(name="Log10 of number of proteins per sample", limits =c(2.8,4.1)) +
  scale_y_continuous(name="Log10 of number of PPIs per sample", limits =c(4,5.4))  + 
  geom_smooth(method='lm', col="red") + 
