...
# vector1 <- vector1[-c(1),]
for (jj in 1:length(PLSDB1$Accession)){ # 17
...
dim(vector1)
# oo <- c(279, 355, 691, 818, 1108, 1153, 1211)
for (k in 3140:3140){ # c(1:4445)){ #     # change k   # 5 =>18 not work # 3726
     ...
     for (m1 in 1:length(links_genes$Gene)){	# for all host proteins # c = number of PPIs
        links_genes$Interactions[m1] <- # count the PPIs
...
for (n2 in 1:length(names2)){ # n2 <- 1568 # E. coli  
  ...
  #   print(name)
   ...
   #  View(in2)
  #   View(ingenes)
     write.csv(in2, paste("~/Desktop/OUTPUT8/", name, sep=""))
     # write.csv(in2, paste("/Volumes/GoogleDrive/My Drive/TDA_Summer2021/RMD_FILES/OUTPUT6/", name, sep=""))
} # end for

samplenames <- data.frame(read.csv("/Volumes/GoogleDrive/My Drive/TDA_Summer2021/RMD_FILES/sample_names_497.csv"))
setwd("~/Desktop/OUTPUT8/") # ??
